...
/* Quick preset amounts for counting cash */
      ...
      <div className="flex items-center justify-center min-h-[60vh] animate-fade-in">
        <div className="rounded-[28px] p-10 text-center max-w-md w-full" style={S.glassPanel}>
          ...
          <button onClick={() => navigate('/cashier/pos')}
            className="w-full py-3 rounded-full font-bold text-sm cursor-pointer transition-all"
            style={S.btnPrimary}>
            Ir al POS →
          </button>
        </div>
      ...
      <div className="rounded-[28px] p-8" style={S.glassPanel}>
        ...
        <div className="space-y-3 mb-8">
          ...
          {PRESETS.map(denom => {
            ...
            return (
              <div key={denom}
                className="grid grid-cols-3 items-center gap-3 rounded-xl px-4 py-3"
                ...
                <div className="flex items-center justify-center gap-2">
                  <button onClick={() => update(denom, qty - 1)}
                    className="w-7 h-7 rounded-full flex items-center justify-center font-bold cursor-pointer transition-all hover:scale-110"
